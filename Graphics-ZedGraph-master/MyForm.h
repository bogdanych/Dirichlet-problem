...
namespace Graph {
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Ïàðàìåòðû ñåòêè:";
			// 
			// label5
			// 
			...
			this->label3->Text = L"Ñåðûå ÿ÷åéêè - ãðàíè÷íûå óñëîâèÿ";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Ðåøåíèå óðàâíåíèÿ Ïóàññîíà ìåòîäîì SOR";
			// 
			// MyForm
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Ðåøåíèå óðàâíåíèÿ ìåòîäîì SOR";
	...
	private:
		void DisplaySolution() {
			...
			label1->Text = String::Format("Ðåøåíèå äëÿ ñåòêè: N = {0}, M = {1}  |  h = {2:F4}  |  k = {3:F4}",
				N, M, h, k);
			label2->Text = String::Format("Ìàêñèìàëüíàÿ ïîãðåøíîñòü: {0:E6}", solver->getError());
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		MessageBox::Show(String::Format("Ðåøåíèå îáíîâëåíî äëÿ ñåòêè {0}x{1}!", N, M), "Ãîòîâî");
